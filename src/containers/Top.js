      ...
      <Grid item xs={12}>
        <Paper className={classes.center} square elevation={0}>
          <div className={classes.content}>
            ...
            <img style={{ margin: '2em 2em 2em 1.7em' }} src={titleGr} alt="Minica" height="40" />
            <Typography align="center" style={{ marginBottom: '2em' }}>
            Minicaは思いついたサービスを小さく速くリリースするためのテンプレートです。
            </Typography>
            <Typography align="center" style={{ marginBottom: '2em' }}>
            トップページ・サインアップ・ログイン・アカウント設定・ログアウトページを提供します。<br />
            </Typography>
